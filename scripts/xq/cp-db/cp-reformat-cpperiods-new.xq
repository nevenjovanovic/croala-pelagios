...
let $doc := doc("https://github.com/nevenjovanovic/croala-pelagios/raw/master/csv/aetates/myth-periods1.xml")
    for $r in $doc//record
...
return file:write("/home/neven/rad/croala-pelagios/csv/aetates/cpperiods-myth-2.xml", $result)
