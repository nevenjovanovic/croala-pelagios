...
declare variable $title := 'CITE URN corporum indiculus; loca in CroALa';
declare variable $content := "Display available CITE bodies URNs of commentary to place names.";
...
declare
  ...
  function page:croalapelagioslistcitebodyurn()
{
