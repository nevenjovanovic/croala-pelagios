(: CroALa Pelagios :)
(: Display all occurrences of a certain aetas CITE URN :)
...
declare variable $title := 'Aetas occurrit in CroALa';
declare variable $content := "Show all occurrences of a period (identified by a CITE URN) in the CroALa index locorum corpus.";
...
declare
  ...
  function page:croalapelagiosciteaetasocc($urn)
{
...
<p>Aetas { $urn } occurrit in collectione.</p>
...
{ cp:aetas_head($urn) , cp:aetas_cite($urn) }
